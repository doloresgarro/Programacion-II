...
Type
     ...
     {a.	Genere una estructura con la información de los productos ordenados por marca,
      donde por cada marca se tengan los productos ordenados por año.   }
      producto2 = record
                codigo: integer;
	            nombre: string;
                anio: 2000..2022;
      ...
      ListaInterna = ^nodoInt;
      nodoInt = record
              dato: producto2; // producto sin la marca xq ya la guardamos anteriormente
              sig: ListaInterna;
              end;

     datosListaNueva = record
                     marca:string;
                     Lista: ListaInterna;
                     end;
